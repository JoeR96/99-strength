...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "text-2xl font-bold leading-tight tracking-wide uppercase font-[Orbitron,sans-serif] text-white",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("text-lg text-gray-400 mt-1 leading-relaxed font-[VT323,monospace]", className)}
    {...props}
  />
))

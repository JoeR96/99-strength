  ...
  return (
    <Dialog open={true} onOpenChange={(open) => { if (!open) onComplete(); }}>
      <DialogContent className="max-w-lg max-h-[80vh] overflow-hidden flex flex-col p-0">
        <DialogHeader className="p-4 border-b bg-yellow-100">
          ...
          <DialogDescription className="text-sm text-yellow-700 mt-1">
        ...
        <div className="p-4 border-t border-border bg-zinc-50 flex justify-end gap-2">

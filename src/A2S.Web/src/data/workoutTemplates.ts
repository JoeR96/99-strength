...
const monkModeTemplate: WorkoutTemplate = {
  id: 'monk-mode',
  name: 'Monk Mode',
  description: 'A 4-day split: quad-focused lower, push upper, posterior lower, pull upper. Squat and Incline Smith as Linear main lifts; assisted pull/dip use MinimalSets.',
  variant: 4,
  totalWeeks: 21,
  blockSequence: [1, 2, 3],
  exercises: [

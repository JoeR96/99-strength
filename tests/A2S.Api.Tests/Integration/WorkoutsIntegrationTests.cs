...
public class WorkoutsIntegrationTests
{
    ...
    public async Task CreateWorkout_WhenActiveWorkoutExists_ReturnsConflict()
    {
        ...
        errorResponse.Should().NotBeNull();
        errorResponse!.Detail.Should().Contain("active workout");
    }
    ...
    {
        var response = await CreateClient().GetAsync("/api/v1/workouts/exercises/library?pageSize=500");
...
internal class ErrorResponse
{
    ...
    // Aliases for backward-compat with tests
    public string? Error => Title;

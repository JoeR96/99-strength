...
public class BlockSequenceIntegrationTests
{
    ...
    {
        // Arrange - create a workout with [1, 1, 2, 3] and verify week 8 uses Block 1 params
        var client = CreateClient();
        var createResponse = await client.PostAsJsonAsync("/api/v1/workouts", new CreateWorkoutCommand(
        ...
        // Act - Get week plan for program week 8 (second Block 1, week 1)

...
public class RepRangeTests
{
    ...
    {
        // Act
        var range = RepRange.Create(8, 12);
    ...
    {
        // Act
        Action act = () => RepRange.Create(0, 12);
    ...
    [Fact]
    public void Create_WithMaximumLessThanMinimum_ShouldThrowException()
    {
        // Act
        Action act = () => RepRange.Create(12, 8);
    ...
    {
        // Act
        Action act = () => RepRange.Create(5, 20);
    ...
    {
        // Assert
        RepRange.Common.Low.Should().Be(RepRange.Create(4, 8));
        RepRange.Common.MediumLow.Should().Be(RepRange.Create(6, 10));
        RepRange.Common.Medium.Should().Be(RepRange.Create(8, 12));
        RepRange.Common.MediumHigh.Should().Be(RepRange.Create(10, 15));
        RepRange.Common.High.Should().Be(RepRange.Create(12, 20));
    }
    ...
    {
        // Arrange
        var range1 = RepRange.Create(8, 12);
        var range2 = RepRange.Create(8, 12);
    ...
    public void Equals_WithDifferentValues_ShouldNotBeEqual()
    {
        // Arrange
        var range1 = RepRange.Create(8, 12);
        var range2 = RepRange.Create(6, 10);
